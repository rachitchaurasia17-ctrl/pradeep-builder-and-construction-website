/* ───────────────────── IntroTunnel ─────────────────────
   ...
   Sequence:
     ...
     2. 'reveal'  — tunnel ends on a clean screen; the
                    Pradeep Builder and Construction lockup fades in
                    and holds.
     3. 'out'     — the whole thing dissolves (fade + scale +
                    blur) into the landing page.
     4. 'gone'    — unmounts and calls onDone().

   Customised for Pradeep Builder and Construction (blue room, brand phrase).
*/
...
const PHRASE = 'Pradeep Builder and Construction · '; // tiled on all 4 walls
  ...
  return (
    <div className={"intro-tunnel intro-" + phase + (phase === "out" ? " intro-fade" : "")}>
      ...
      <div className="intro-center">
        <div className="intro-logo"><span>Pradeep Builder and Construction</span><span>REALTY</span></div>
